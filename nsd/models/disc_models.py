...
from nsd.models.sheaf_models import LocalConcatSheafLearner, EdgeWeightLearner, LocalConcatSheafLearnerVariant
...
class DiscreteBundleSheafDiffusion(SheafDiffusion):
    ...
    def forward(self, x):
        ...
        x = x.reshape(self.graph_size, -1)
        x = self.lin2(x)
        # return F.log_softmax(x, dim=1)  # ONLY modification
        return x
